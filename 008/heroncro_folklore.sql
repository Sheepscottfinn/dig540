...
--
-- Host: localhost:3306
-- Generation Time: Oct 17, 2015 at 12:09 PM
...
CREATE TABLE IF NOT EXISTS `contributor` (
  ...
  PRIMARY KEY (`id`),
  KEY `name-last` (`last_name`),
  KEY `origin` (`origin`),
  KEY `name_first` (`first_name`)
...
INSERT INTO `contributor` (`id`, `last_name`, `first_name`, `origin`) VALUES
...
INSERT INTO `media` (`id`, `media_type`, `story_id`, `theme_id`, `contributor_id`) VALUES
(1, 'radio', 5, 3, 1),
(2, 'disc', 2, 7, 2),
(3, 'book', 1, 6, 3);
...
CREATE TABLE IF NOT EXISTS `story` (
  `id` int(8) NOT NULL,
  `story_name` enum('river lee in cork','grandad','spring festival','first communion','at the quay in cork','growing up in germany','cold and different','exchange studies uc cork','patrick street cork city','walking cork','cycling cork','bringing traditions','southwest cork pub music','cork talk') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `contributor_id` int(8) NOT NULL,
