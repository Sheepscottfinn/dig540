...
CREATE TABLE IF NOT EXISTS `story` (
  `id` int(8) NOT NULL,
  `story_name` enum('pub music','bicycling in cork','spring festival','river lee','first communion','cold and different','ucc','grandad','local talk','at the quay','shops') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `contributor_id` int(8) NOT NULL,
