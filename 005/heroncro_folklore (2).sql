This is the updated database for Folklore
...
--
-- Host: localhost:3306
-- Generation Time: Oct 17, 2015 at 11:11 AM
...
CREATE TABLE IF NOT EXISTS `contributor` (
  ...
  PRIMARY KEY (`id`),
  KEY `name-last` (`lastname`),
  KEY `origin` (`origin`),
  KEY `name_first` (`firstname`)
...
INSERT INTO `contributor` (`id`, `lastname`, `firstname`, `origin`) VALUES
...
CREATE TABLE IF NOT EXISTS `media` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `mediatype` enum('radio','disc','book') COLLATE utf8_unicode_ci NOT NULL,
  `story_id` int(8) NOT NULL,
  `theme_id` int(8) NOT NULL,
  `contributor_id` int(8) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `media_type` (`mediatype`),
...
INSERT INTO `media` (`id`, `mediatype`, `story_id`, `theme_id`, `contributor_id`) VALUES
(1, 'radio', 5, 3, 1),
(2, 'disc', 2, 7, 2),
(3, 'book', 1, 6, 3);
...
CREATE TABLE IF NOT EXISTS `story` (
  `id` int(8) NOT NULL,
  `storyname` enum('pub music','bicycling in cork','spring festival','river lee','first communion','cold and different','ucc','grandad','local talk','at the quay','shops') CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `contributor_id` int(8) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `theme` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `themename` enum('the emigration experience','neighborhoods','family','food','sports and games','coming to Cork','our city') COLLATE utf8_unicode_ci NOT NULL,
  `media_id` int(8) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `media_id` (`media_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=11 ;
...
INSERT INTO `theme` (`id`, `themename`, `media_id`) VALUES
...
--
ALTER TABLE `media`
  ADD CONSTRAINT `media_ibfk_1` FOREIGN KEY (`story_id`) REFERENCES `story` (`id`),
  ADD CONSTRAINT `media_ibfk_2` FOREIGN KEY (`theme_id`) REFERENCES `theme` (`id`),
  ADD CONSTRAINT `media_ibfk_3` FOREIGN KEY (`contributor_id`) REFERENCES `contributor` (`id`);
